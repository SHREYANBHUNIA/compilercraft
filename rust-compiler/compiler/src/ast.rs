...
#[derive(Debug, Clone, Serialize)] pub enum Expression { Integer(i64), Bool(bool), String(String), Identifier(String), Array(Vec<Expression>), Binary { operator: BinaryOperator, left: Box<Expression>, right: Box<Expression> } }
